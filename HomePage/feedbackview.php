  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <li ><a href="../AdminDashboard/adminDash.php">Dashboard</a></li>
        ...
        <li class="active"><a href="../HomePage/feedbackview.php">Feedback</a></li>
...
<div class="well">
        <table>
            ...
            <h3 class="empal">Feedback INFO</h3>
            <!--search-->
            <div>
...
if( isset( $_POST['search']))
 {
$search = $_POST["search"]; 
$sql = "SELECT * FROM `feedback` WHERE `name` LIKE '%".$search."%'  OR `desc` LIKE '%".$search."%'";
