...
?>
                    ...
                    <table>
                        ...
                        <td><a href="../PHP/updatePatient.php?patient_id=<?php echo $row["patient_id"]; ?>">Update</a>
                        <a href="../PHP/deletePatient.php?patient_id=<?php echo $row["patient_id"]; ?>">Delete</a></td>
                          </tr>
                          <?php
                          $i++;
                          }
                    ...
                    <?php
                      ...
                      ?>
<button class="btncreate">  <a style="text-decoration:none; color:white;" href="../HTML/addPatient.html"> Add Patient</a>
